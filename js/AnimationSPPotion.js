class AnimationSPPotion extends Animation{
	...
	constructor(m, a, b, c, d, hi) {
		...
		this.aniRowNumber = 5;
		this.high = hi;
		this.frame = this.frame1 = this.frame2 = this.frame3 = 6;
		this.mon = m;
		this.loadLock = true;
	...
	paintAnimation(g) {
		...
		this.tic++;
		this.frame = this.tic + 6;
		this.frame1 = this.tic + 3;
		this.frame2 = this.tic - 0;
		this.frame3 = this.tic - 3;
