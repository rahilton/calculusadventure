class AnimationStandard extends Animation{
	
	//a = x-coordinate, b = y-coordinate, c = length of display, d = height of display
	
	constructor(filename, a, b, c, d, max, div) {
		super(filename,a,b,c,d);
		this.file = filename;
		this.tic = 0;
		this.maxTics = max;
		this.aniWidth = 960/div;
		this.aniHeight = 960/div;
		this.aniRowNumber = 5;
		this.frame = 0;
	...
	paintAnimation(g) {
		...
		g.drawImage(this.gfx, (this.frame%this.aniRowNumber)*this.aniWidth,
