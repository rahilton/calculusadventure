class AnimationMakeShield extends Animation{
	...
	constructor(m, a, b, c, d, shield) {
		...
		this.frame = 0;
		this.mon = m;
		this.newShield = shield.substring(7);
		this.loadLock = true;
	...
	paintAnimation(g) {
		...
		this.tic++;
		this.frame = this.tic;
		if(this.tic == this.maxTics) {this.setFinished(true); this.mon.addShield(this.newShield);}
	}
