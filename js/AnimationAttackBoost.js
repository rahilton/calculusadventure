 class AnimationAttackBoost extends Animation{
	...
	constructor(p, magLev, a, b, c, d) {
	 ...
	 paintAnimation(g) {
		...
		this.tic++;
		this.frame = this.tic;
		if(this.tic == this.maxTics) {this.setFinished(true); this.play.makeAttackBoost(this.magicLevel*15 + Math.floor(Math.random() * 10));}
	}
